...
import com.example.loginandsignup.Found
import com.example.loginandsignup.Lost
import com.example.loginandsignup.Models.Item
import com.example.loginandsignup.R

class MyNewAdapter(val context: Context, private val itemList: ArrayList<Item> = ArrayList<Item>(), private val onItemClickListener: Found) : RecyclerView.Adapter<MyNewAdapter.MyViewHolder>() {
